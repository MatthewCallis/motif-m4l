...
var MotifEngine = (() => {
    ...
    In = (e, t, n, r) => {
      if ((t && typeof t == "object") || typeof t == "function")
        for (let i of vn(t))
          !kn.call(e, i) &&
            i !== n &&
            Le(e, i, { get: () => t[i], enumerable: !(r = Mn(t, i)) || r.enumerable });
      return e;
    };
  var xn = (e) => In(Le({}, "__esModule", { value: !0 }), e);
  var et = (e, t, n) => t.has(e) || Ze("Cannot " + n);
  var x = (e, t, n) => (et(e, t, "read from private field"), n ? n.call(e) : t.get(e)),
    tt = (e, t, n) =>
      t.has(e)
        ? Ze("Cannot add the same private member more than once")
        : t instanceof WeakSet
          ? t.add(e)
          : t.set(e, n),
    K = (e, t, n, r) => (et(e, t, "write to private field"), r ? r.call(e, n) : t.set(e, n), n);
  var br = {};
  Sn(br, { dispatch: () => gr });
  function v(e, t, n) {
  ...
  function wn(e) {
    let t = [...new Set(e.map((n) => Q(Math.round(n), 12)))].sort((n, r) => n - r);
  ...
  function nt(e, t, n, r) {
    return v(e + W(e, t, n, r), 0, 127);
  }
  function rt(e, t) {
    return v(e + t, 0, 127);
  }
  function it(e, t, n, r, i) {
    return v(e + W(e, t, r, i) + n, 0, 127);
  }
  function _n(e, t, n = 60, r = 0) {
  ...
  function ot(e, t, n) {
    ...
    let r = _n(e, n.scaleIntervals, n.triggerPitch, n.rootNote);
  ...
  function Nn(e, t, n) {
    return t === "chromatic"
      ...
      : W(n.triggerPitch, e.pitch, n.rootNote, n.scaleIntervals) +
          (t === "hybrid" ? (e.accidental ?? 0) : 0);
  }
  function st(e, t, n) {
    if (e.pitchMode === t) return e;
    let r = e.notes.map((i) => {
      let o = Nn(i, e.pitchMode, n),
        s = ot(o, t, n),
  ...
  function at(e, t) {
    ...
    let r = t.rootNote ?? n[0]?.pitch ?? 60,
      ...
      o = n.map((a) => {
        let c = a.pitch - r;
        return { at: a.at, duration: a.duration, ...ot(c, t.pitchMode, i), velocity: a.velocity };
      }),
  ...
  function $e(e, t, n, r) {
    switch (r.pitchMode ?? t.pitchMode) {
      case "chromatic":
        return rt(r.triggerPitch, e.pitch + (e.accidental ?? 0));
      case "hybrid":
        return it(r.triggerPitch, e.pitch, e.accidental ?? 0, n.rootNote, n.scaleIntervals);
      default:
        return nt(r.triggerPitch, e.pitch, n.rootNote, n.scaleIntervals);
    }
  }
  function An(e, t, n) {
  ...
  function dt(e, t, n) {
    ...
    for (let f = 0; f < e.notes.length; f += 1) {
      ...
      let w = e.notes[f + 1],
        E = $e(y, e, t, n),
        U = Tn(y, e, n.triggerVelocity),
        h = a + Math.max(0, y.at * o),
        _ = An(y, w, e) * o,
        N = Math.max(h, h + _);
      (u.push({
        pitch: E,
  ...
  function De(e, t, n, r, i, o = 64) {
    let s = r ?? e.pitchMode,
      ...
      E = y.length > 0 ? Math.max(...y) : n,
      U = w === E ? w - 1 : w,
      h = w === E ? E + 1 : E,
      N = Math.max(1, e.length * u) / Math.max(1, i === "fit-bar" ? c : a);
    return {
      notes: f,
      noteNames: f.map((C) => Oe(C.pitch)),
      lowPitch: U,
      highPitch: h,
      bars: N,
  ...
  function ye(e, t) {
    ...
    let r = (t.reverse ? [...e.notes].reverse() : e.notes).map((i) => {
      ...
      return (
        t.invert &&
          ((o.pitch = ft(i.pitch)), i.accidental !== void 0 && (o.accidental = ft(i.accidental))),
  ...
  function Pn(e, t, n) {
    if (!ae(e)) return (n.push(`${t} must be an object`), !1);
    let r = !0;
    return (
  ...
  function j(e, t, n, r, i = () => !0, o = "a finite number") {
    let s = e[t];
    s !== void 0 && (!V(s) || !i(s)) && r.push(`${n}.${t} must be ${o}`);
  }
  function Ln(e, t, n) {
    let r = `notes[${t}]`;
    if (!ae(e)) return (n.push(`${r} must be an object`), !1);
    ((!V(e.at) || e.at < 0) && n.push(`${r}.at must be a non-negative number`),
      (!V(e.duration) || e.duration <= 0) && n.push(`${r}.duration must be greater than zero`),
      V(e.pitch) || n.push(`${r}.pitch must be a number`),
      j(e, "accidental", r, n),
      j(e, "velocity", r, n, (i) => i >= 1 && i <= 127, "between 1 and 127"),
      j(e, "velocityOffset", r, n),
      j(e, "velocityScale", r, n, (i) => i >= 0, "zero or greater"),
      j(e, "gate", r, n, (i) => i > 0, "greater than zero"));
  ...
  function Rn(e, t) {
    if (e !== void 0) {
      ...
      for (let n of ["inputMin", "inputMax", "outputMin", "outputMax"]) j(e, n, "velocityCurve", t);
      j(e, "exponent", "velocityCurve", t, (n) => n > 0, "greater than zero");
    }
  }
  function ve(e) {
    let t = [];
    if (!ae(e)) return { valid: !1, errors: ["motif must be an object"] };
    ...
    if (
      (En(e.pitchMode) || t.push("pitchMode must be scale, chromatic, or hybrid"),
      Pn(e.sourceMeter, "sourceMeter", t),
      (!V(e.length) || e.length <= 0) && t.push("length must be greater than zero"),
      j(e, "defaultGate", "motif", t, (n) => n > 0, "greater than zero"),
      Rn(e.velocityCurve, t),
  ...
  var X = class {
    constructor(t) {
      this.motifs = new Map();
      this.builtinIds = new Set(Me.map((t) => t.id));
      this.sortedList = null;
      ((this.currentId = t ?? Me[0]?.id ?? ""), this.resetToBuiltins(), this.ensureCurrent());
    }
    ...
    resetToBuiltins() {
      this.motifs.clear();
      for (let t of Me) this.motifs.set(t.id, t);
  ...
  var k,
    ke = class {
      ...
      isEditing(t) {
        return x(this, k) !== void 0 && (t === void 0 || x(this, k).targetId === t);
      }
      isDirty() {
        return x(this, k)?.dirty ?? !1;
      }
      current(t) {
        let n = x(this, k)?.targetId;
        return n ? t.get(n) : void 0;
      }
      begin(t, n, r = {}) {
        if (x(this, k)) return x(this, k).targetId === n ? t.get(x(this, k).targetId) : void 0;
        let i = t.get(n);
        if (i) {
          if (t.isBuiltin(n)) {
            let o = t.uniqueId(r.targetId ?? ce(i.name, `${i.id}-copy`)),
              s = { ...He(i), id: o };
      ...
      markDirty() {
        x(this, k) && (x(this, k).dirty = !0);
      }
      cancel(t) {
        let n = x(this, k);
        if (n)
          return (
            n.created ? t.remove(n.targetId) : t.update(n.original), K(this, k, void 0), n.sourceId
          );
      }
      finishSave() {
        let t = x(this, k)?.targetId;
        return (K(this, k, void 0), t);
      }
      abandon() {
        K(this, k, void 0);
      }
  ...
  function Se(e, t) {
    ...
    if (Array.isArray(e) || Array.isArray(t))
      return (
        ...
        Array.isArray(t) &&
        e.length === t.length &&
        e.every((i, o) => Se(i, t[o]))
      );
    if (!D(e) || !D(t)) return !1;
    let n = Object.keys(e),
      r = Object.keys(t);
    return n.length === r.length && n.every((i) => P(t, i) && Se(e[i], t[i]));
  }
  var $n = [
    "pitch",
    "accidental",
  ...
  function Fe(e, t, n = () => !0, r = "a finite number") {
  ...
  function ht(e, t, n) {
    ...
    if (P(r, "id") && Ie(r.id) !== e.id)
      return { ok: !1, error: "Motif ID is generated and cannot be changed" };
    if (P(r, "schemaVersion") && Number(r.schemaVersion) !== e.schemaVersion)
      return { ok: !1, error: "schemaVersion is read-only" };
    if (P(r, "length") && Number(r.length) !== e.length)
      return {
        ok: !1,
    ...
    let i = e.name;
    if (P(r, "name")) {
      let h = pt(r.name, "Motif name");
      if (!h.ok) return h;
      i = h.value;
    }
    let o = e.description;
    if (P(r, "description")) {
      let h = pt(r.description, "Motif description");
      if (!h.ok) return h;
      o = h.value;
    }
    let s = e.pitchMode;
    if (P(r, "pitchMode")) {
      let h = Ie(r.pitchMode);
      if (h !== "scale" && h !== "chromatic" && h !== "hybrid")
        return { ok: !1, error: "pitchMode must be scale, chromatic, or hybrid" };
      s = h;
    }
    let a = e.sourceMeter;
    if (P(r, "sourceMeter")) {
      let h = D(r.sourceMeter) ? r.sourceMeter : void 0;
      if (!h) return { ok: !1, error: "sourceMeter must be an object" };
      let _ = Number(h.numerator),
        N = Number(h.denominator);
    ...
    let c = e.defaultGate;
    if (P(r, "defaultGate")) {
      let h = Fe(r.defaultGate, "defaultGate", (_) => _ > 0, "greater than zero");
      if (!h.ok) return h;
      c = h.value;
    }
    let u = e.velocityCurve;
    if (P(r, "velocityCurve")) {
      let h = r.velocityCurve;
      if (h == null) u = void 0;
      else {
        let _ = D(h) ? h : void 0;
        if (!_) return { ok: !1, error: "velocityCurve must be an object" };
        let N = {};
        for (let se of ["inputMin", "inputMax", "outputMin", "outputMax"]) {
          let be = Fe(_[se], `velocityCurve.${se}`);
          if (!be.ok) return be;
          be.value !== void 0 && (N[se] = be.value);
        }
        let C = Fe(_.exponent, "velocityCurve.exponent", (se) => se > 0, "greater than zero");
        if (!C.ok) return C;
    ...
    let f =
      ...
      { defaultGate: y, velocityCurve: w, ...E } = f,
      U = {
        ...E,
        name: i,
        description: o,
    ...
    return { ok: !0, value: U, changed: !Se(U, e) };
  }
  function gt(e, t, n, r) {
    if (!$n.includes(n)) return { ok: !1, error: `Unknown note field: ${n}` };
  ...
  var H = "scale-turn",
    ...
    kt = [0.5, 1, 1.5, 2],
    Z = 512,
    St = ["scale", "chromatic", "hybrid"],
    It = ["preserve", "fit-bar"],
    we = ["replace", "overlap"],
    xt = ["one-shot", "hold", "hold-repeat", "toggle", "latch", "release-tail"],
    wt = ["immediate", "1/16", "1/8", "1/4", "bar"],
    _t = ["none", "non-triggers", "all"];
  function S(...e) {
    outlet(0, ...e);
  }
  function m(...e) {
...
`));
  ...
  function Nt(e) {
    return z(e).map(Number).filter(Number.isFinite);
  }
  function Be(e, t) {
...
`);
  ...
  function Pt(e, t) {
    ...
    try {
      ...
      ((r.eof = 0), (r.position = 0), On(r, t));
      let i = Be(r.foldername, e);
      (r.close(), (r = void 0));
...
`;
  ...
  function Ve(e, t) {
    ...
    let n = ct(t, e.timeSignature);
    return ut(Math.max(0, e.currentSongTime * 960), n);
  }
  function ze(e, t, n, r) {
    let i = t === "preserve" ? e.length : e.length * ($(n.timeSignature) / $(e.sourceMeter));
    return Math.max(xe, J(i, n.tempo * r));
  }
  function $t(e) {
    return z(e)
      .map(String)
  ...
  function Ot(e) {
    ...
    return kt.some((n) => n === t) ? t : void 0;
  }
  function Dt(e) {
    return e === 1 ? we[0] : e === 0 ? we[1] : typeof e == "string" && Y(e, we) ? e : void 0;
  }
  function Ht(e) {
  ...
  function Ft(e) {
    ...
    try {
      let s = e.trim();
      t = JSON.parse(s.startsWith("{") ? s : decodeURIComponent(s));
    } catch {
      return;
    }
    if (!t || typeof t != "object") return;
    let n = t;
    if (n.schemaVersion !== 1) return;
    let r = typeof n.selectedMotifId == "string" ? n.selectedMotifId.trim() : "";
    if (!r) return;
    let i = new Map(),
      o = Array.isArray(n.hotkeys) ? n.hotkeys : [];
    for (let s of o) {
      if (!s || typeof s != "object") continue;
      let a = s,
        c = Number(a.pitch),
        u = typeof a.motifId == "string" ? a.motifId.trim() : "",
        f = a.action;
      !Number.isInteger(c) ||
        c < 0 ||
        c > 127 ||
        !u ||
        (f !== "trigger" && f !== "select") ||
        i.set(c, { pitch: c, motifId: u, action: f });
    }
    return {
      schemaVersion: 1,
      selectedMotifId: r,
      hotkeys: [...i.values()].sort((s, a) => s.pitch - a.pitch),
    };
  }
  function Bt(e) {
    if (typeof e == "string") {
  ...
  var _e = class {
    ...
    list() {
      return [...this.mappings]
        .map(([t, n]) => ({ pitch: t, motifId: n.motifId, action: n.action }))
        .sort((t, n) => t.pitch - n.pitch);
    }
  ...
  function Ne(e) {
    if (Array.isArray(e)) return Ne(e[0]);
  ...
  function zt(e) {
    try {
      if (Ne(e.get("is_midi_clip"))) return !0;
      if (Ne(e.get("is_audio_clip"))) return !1;
    } catch {}
    return !0;
  }
  function Gt() {
  ...
  var Ce = class {
    ...
    reserve(t) {
      this.occupiedPaths.add(ee(t));
    }
    isOccupied(t) {
      return this.occupiedPaths.has(ee(t));
    }
    uniqueId(t, n = "motif") {
      ...
      return n.pathname
        ? ((this.scanGeneration += 1),
          ...
          (this.scanState = {
            ...
            visited: new Set([ee(this.path).replace(/\/+$/, "")]),
            candidateStore: new X(),
    ...
    loadMotifFile(t, n, r) {
      r.candidateOccupiedPaths.add(ee(t));
      try {
        let i = ve(Ct(t));
  ...
  var d = new X(H),
    ...
    pe = new Set();
  function M() {
    let e = de.trim().toLowerCase(),
      t = new Set(d.filter(de).map((u) => u.id)),
      n = d
        .list()
        .filter((u) => !e || t.has(u.id) || p.browserFolder(u.id).toLowerCase().includes(e))
        .sort(
          (u, f) =>
            p.browserFolder(u.id).localeCompare(p.browserFolder(f.id)) ||
    ...
    let a = null;
    if (r) {
      let u = r.notes.map(jt),
        f = De(ye(r, { invert: re, reverse: ie }), { ...g, tempo: g.tempo * G }, he, ne, oe),
        y = Rt(f, r.sourceMeter);
      a = {
        ...
        isPersisted: p.files.has(r.id),
        folder: p.browserFolder(r.id),
        hotkeys: L.forMotif(r.id).map(qe),
        noteCount: r.notes.length,
        noteLimit: Z,
        canAddNote: o && r.notes.length < Z,
    ...
    let c = {
      ...
      items: n.map((u) => ({
        ...
        folder: p.browserFolder(u.id),
        hotkeys: L.forMotif(u.id).map(qe),
      })),
      selectedIndex: i,
      selected: a,
      editing: b.snapshot(),
      libraryPath: p.path,
      libraryLoaded: p.loaded,
      libraryScanning: p.scanning,
      actions: {
        editing: o,
        canEdit: !!r && !p.scanning,
        canSave: o && p.loaded,
        canImportClip: !p.scanning,
        canRefreshLibrary: !!p.path && !p.scanning,
      },
      alert: Xt ?? null,
      scanProgress: p.scanState
        ? { processedEntries: p.scanState.processedEntries, loadedMotifs: p.scanState.loadedMotifs }
        : null,
    };
    Yt += 1;
    for (let u of Vt(c, Yt)) S("ui", "lib", u);
  }
  function Zt(e, t) {
    ((Jt += 1), (Xt = { id: Jt, title: e, message: t }), l(t), M());
  }
  function en() {
    let e = d.current;
    if (!e) return;
    let t = De(ye(e, { invert: re, reverse: ie }), { ...g, tempo: g.tempo * G }, he, ne, oe),
    ...
    S("ui", "preview", encodeURIComponent(JSON.stringify(r)));
  }
  function I() {
    (M(), en());
  }
  function ge() {
    (S("clear"), S("panic"), ue.clear(), Ae.clear());
  }
  function jn(e, ...t) {
    e = String(e);
    let n = Nt(t);
    switch (e) {
      case "tempo": {
        let r = n[0];
        r !== void 0 && r > 0 && (g.tempo = r);
        break;
      }
      case "root_note": {
        let r = n[0];
        r !== void 0 && ((g.rootNote = Math.round(r)), Wt || (he = 60 + g.rootNote), I());
        break;
      }
      case "scale_mode": {
        ((g.scaleMode = (n[0] ?? 0) !== 0), I());
        break;
      }
      case "scale_intervals": {
        n.length > 0 && ((g.scaleIntervals = n.map(Math.round)), I());
        break;
      }
      case "scale_name": {
        let r = z(t).map(String).join(" ").trim();
        r && ((g.scaleName = r), I());
        break;
      }
      case "signature_numerator": {
        let r = n[0];
        r !== void 0 && r > 0 && ((g.timeSignature.numerator = Math.round(r)), I());
        break;
      }
      case "signature_denominator": {
        let r = n[0];
        r !== void 0 && r > 0 && ((g.timeSignature.denominator = Math.round(r)), I());
        break;
      }
      case "is_playing": {
        let r = g.isPlaying;
        ((g.isPlaying = (n[0] ?? 0) !== 0), r && !g.isPlaying && (Ke(), ge()));
        break;
      }
      case "current_song_time": {
        let r = n[0];
        r !== void 0 && r >= 0 && (g.currentSongTime = r);
        break;
      }
      default:
  ...
  function A() {
    ...
    let e = d.labels();
    S("motifs-reset");
    for (let t of d.list()) S("motif-item", e.get(t.id) ?? t.name);
    (S("motif-selected", e.get(d.currentId) ?? d.current?.name ?? d.currentId), I());
  }
  function q() {
    let e = b.snapshot(),
      t = e.active && e.created && e.sourceId ? e.sourceId : d.currentId;
    S(
      "persist",
      Ht({
        schemaVersion: 1,
        selectedMotifId: t,
        hotkeys: L.list().filter((n) => d.isBuiltin(n.motifId) || p.files.has(n.motifId)),
      }),
    );
  }
  function tn() {
    if (!Te || p.scanning || (p.path !== "" && !p.loaded)) return !1;
    let e = Te;
    Te = void 0;
    for (let t of L.clear()) B(t, !1);
    for (let t of e.hotkeys) d.has(t.motifId) && L.assign(t.pitch, t.motifId, t.action);
    return (d.select(e.selectedMotifId) || d.ensureCurrent(H), !0);
  }
  function Vn(...e) {
    let t = z(e)
        .map((i) => T(i))
    ...
    let r = Ft(n);
    if (!r) {
      n !== "0" && l("Saved device state is invalid or from an unsupported version");
      return;
    }
    ((Te = r), tn() && A());
  }
  function nn() {
    S("midi-pass", le === "none" ? 0 : 1);
  }
  function zn() {
    (Qt || ((Qt = !0), m("Ready"), nn()), A(), We());
  }
  function Gn() {
    try {
      let e = Pt(
        "uttori-motif-library-dc6091298eae.html",
...
</style></head><body><div id="app"><div id="left"><div id="search-row"><input
            id="search"
            type="text"
            placeholder="Search..."
            autocomplete="off"
            spellcheck="false"
          /><button id="clear-search" title="Clear search">\u2715</button></div><div id="browser-list"></div><div id="browser-actions"><button class="btn" id="choose-btn" title="Choose and remember a library folder">
            Choose
          </button><button class="btn" id="refresh-btn" title="Reload the chosen library folder">
            Refresh
          </button></div><div id="library-path" title="No user library selected">Built-ins only</div></div><div id="right"><div id="meta"><div id="meta-row-1"><input
              class="field"
              id="name-edit"
              type="text"
              placeholder="(no motif selected)"
              readonly
            /><button class="btn" id="edit-btn">Edit</button><button class="btn hidden" id="cancel-edit-btn">Cancel Edit</button></div><textarea
            class="field"
            id="description-edit"
            placeholder="Description"
            readonly
          ></textarea><div id="stats-line">\u2013</div><div id="edit-state"></div></div><div id="detail-actions"><select
            class="field"
            id="import-mode"
            title="Chromatic preserves the MIDI exactly; Scale and Hybrid encode relative scale degrees"
          ><option value="chromatic">Exact / Chromatic</option><option value="hybrid">Hybrid</option><option value="scale">Scale</option></select><button class="btn accent" id="import-clip-btn">Import Clip</button><button class="btn" id="save-motif-btn">Save &amp; Finish</button></div><div id="panel-tabs"><button class="panel-tab active" data-panel="properties">Properties</button><button class="panel-tab" data-panel="notes">Notes</button></div><div class="panel" id="properties-panel"><div class="section"><div class="section-title">Identity</div><div class="property-grid"><label for="id-display">ID</label
              ><input class="field identity" id="id-display" readonly /><label for="schema-display">Schema</label
              ><input class="field identity" id="schema-display" readonly /><label for="length-display">Length</label
              ><input class="field identity" id="length-display" readonly /><div class="help">
                ID is generated once and remains stable. Length is recalculated from the final note
                end.
              </div></div></div><div class="section"><div class="section-title">MIDI Hot Keys</div><div class="property-grid"><label for="hotkey-input">Trigger note</label><div class="wide" id="hotkey-controls"><input
                  ...
                  autocomplete="off"
                  spellcheck="false"
                /><select class="field" id="hotkey-action"><option value="trigger">Trigger Motif</option><option value="select">Select Motif</option></select><button class="btn" id="assign-hotkey-btn">Assign to Motif</button></div><label>Assigned</label><div class="wide" id="hotkey-list"></div><div class="help">
                Trigger Motif plays this motif using the device\u2019s current Trigger Mode. Select Motif
                makes it active for later trigger-zone notes. Enter a note name such as C3, F\u266F2, or
                Bb4; click an assignment to remove it.
              </div></div></div><div class="section"><div class="section-title">Pitch &amp; Timing</div><div class="property-grid"><label for="pitch-mode-edit">Pitch mode</label><select class="field editable-property" id="pitch-mode-edit" disabled><option value="scale">Scale</option><option value="chromatic">Chromatic</option><option value="hybrid">Hybrid</option></select><label for="default-gate-edit">Default gate</label
              ><input
                ...
                placeholder="1"
                disabled
              /><label for="meter-numerator-edit">Source meter</label><div id="source-meter-controls"><input
                  class="field editable-property"
...
ID: \${o.id}\`:o.name,s.addEventListener("click",()=>{var r;((r=e.selected)==null?void 0:r.id)!==o.id&&x(()=>p({type:"select_browser",id:o.id,discardChanges:!0}))}),t.append(s)}}function U(e){var o;let t=i("hotkey-input"),n=i("hotkey-action"),a=i("assign-hotkey-btn"),d=i("hotkey-list"),c=(o=e==null?void 0:e.hotkeys)!=null?o:[];if(t.disabled=!e,n.disabled=!e,a.disabled=!e,d.innerHTML="",!!e){if(c.length===0){let l=document.createElement("span");l.className="help",l.textContent="None",d.append(l);return}for(let l of c){let s=document.createElement("button");s.className="hotkey-chip";let b=l.action==="select"?"Select":"Trigger";s.title=\`Remove \${l.label} \\xB7 \${b}\`,s.textContent=\`\${l.label} \\xB7 \${b}  \\xD7\`,s.addEventListener("click",()=>{p({type:"unmap_trigger",pitch:l.pitch})}),d.append(s)}}}function O(e,t){var d,c;let n=(c=(d=e==null?void 0:e.selected)==null?void 0:d.notes)!=null?c:[],a=i("note-rows");a.innerHTML="",n.forEach((o,l)=>{var T;let s=document.createElement("div");s.className="note-row";let b=document.createElement("span");b.textContent=String(l+1),s.append(b);for(let y of te){if(y.type==="checkbox"){let h=document.createElement("label");h.className="check-cell";let v=document.createElement("input");v.type="checkbox",v.checked=!!o[y.name],v.disabled=!t,v.addEventListener("change",()=>{p({type:"edit_note_at",index:l,field:y.name,value:v.checked})}),h.append(v),s.append(h);continue}let g=document.createElement("input");g.type="number";let _=o[y.name];g.value=_==null?"":String(_),g.disabled=!t,y.min!==void 0&&(g.min=y.min),y.max!==void 0&&(g.max=y.max),y.step!==void 0&&(g.step=y.step),g.addEventListener("change",()=>{let h=g.value===""?null:Number(g.value);h!==null&&!Number.isFinite(h)||p({type:"edit_note_at",index:l,field:y.name,value:h})}),s.append(g)}let r=document.createElement("button");r.className="remove-btn",r.textContent="\\u2715",r.title="Remove note",r.disabled=!((T=e==null?void 0:e.selected)!=null&&T.canRemoveNote),r.addEventListener("click",()=>p({type:"remove_note",index:l})),s.append(r),a.append(s)})}function m(e,t,n){let a=i(e);document.activeElement===a&&n||(typeof t=="string"?a.value=t:typeof t=="number"||typeof t=="boolean"?a.value=String(t):a.value="")}function q(e){for(let t of G){let n=i(t);if((n instanceof HTMLInputElement||n instanceof HTMLTextAreaElement)&&(t==="name-edit"||t==="description-edit")){n.readOnly=!e;continue}n.disabled=!e}}function V(e,t){var a,d,c,o;let n=e==null?void 0:e.velocityCurve;m("id-display",(a=e==null?void 0:e.id)!=null?a:"",!1),m("schema-display",e?\`v\${e.schemaVersion}\`:"",!1),m("length-display",e?\`\${e.length} ticks\`:"",!1),m("pitch-mode-edit",(d=e==null?void 0:e.pitchMode)!=null?d:"scale",t),m("default-gate-edit",e==null?void 0:e.defaultGate,t),m("meter-numerator-edit",(c=e==null?void 0:e.sourceMeter.numerator)!=null?c:"",t),m("meter-denominator-edit",(o=e==null?void 0:e.sourceMeter.denominator)!=null?o:4,t),m("curve-input-min",n==null?void 0:n.inputMin,t),m("curve-input-max",n==null?void 0:n.inputMax,t),m("curve-output-min",n==null?void 0:n.outputMin,t),m("curve-output-max",n==null?void 0:n.outputMax,t),m("curve-exponent",n==null?void 0:n.exponent,t)}function le(e,t){var s;let n=(s=e==null?void 0:e.selected)!=null?s:null,a=!!(e!=null&&e.actions.editing),d=i("edit-btn"),c=i("cancel-edit-btn"),o=i("save-motif-btn"),l=i("add-note-btn");if(i("import-clip-btn").disabled=!(e!=null&&e.actions.canImportClip),!n||!e){m("name-edit","",!1),m("description-edit","",!1),q(!1),V(null,!1),i("stats-line").textContent="\\u2013",i("edit-state").textContent="",d.disabled=!0,c.classList.add("hidden"),o.disabled=!0,l.disabled=!0,O(e,!1),U(null);return}m("name-edit",n.name,a),m("description-edit",n.description,a),q(a),V(n,a),i("stats-line").textContent=n.stats,i("edit-state").textContent=a?\`\${e.editing.dirty||t.formDirty?"Unsaved changes":"Editing"} \\xB7 \${n.id}\`:n.isBuiltin?"Built-in \\xB7 Edit creates a user copy":\`\${n.isPersisted?"Saved":"Not yet saved"} \\xB7 \${n.id}\`,d.classList.toggle("hidden",a),d.disabled=!e.actions.canEdit,c.classList.toggle("hidden",!a),c.disabled=!1,o.disabled=!e.actions.canSave,o.title=e.libraryLoaded?"Save changes and exit editing":"Choose a valid library folder before saving",l.disabled=!n.canAddNote,O(e,a),U(n)}function se(e){i("properties-panel").classList.toggle("hidden",e!=="properties"),i("notes-panel").classList.toggle("hidden",e!=="notes"),document.querySelectorAll(".panel-tab").forEach(t=>{t.classList.toggle("active",t.dataset.panel===e)})}function z(e){let{server:t}=e;re(t),le(t,e),oe(e.modal),se(e.activePanel);let n=i("search");t&&document.activeElement!==n&&(n.value=t.query);let a=i("library-path");a.textContent=t!=null&&t.libraryPath?\`\${t.libraryScanning?"Scanning \\xB7 ":t.libraryLoaded?"":"Unavailable \\xB7 "}\${t.libraryPath}\`:"Built-ins only",a.title=(t==null?void 0:t.libraryPath)||"No user library selected";let d=i("refresh-btn");d.disabled=!(t!=null&&t.actions.canRefreshLibrary),d.textContent=t!=null&&t.libraryScanning?"Scanning...":"Refresh"}function W(){return{name:i("name-edit").value,description:i("description-edit").value,pitchMode:i("pitch-mode-edit").value,sourceMeter:{numerator:Number(i("meter-numerator-edit").value),denominator:Number(i("meter-denominator-edit").value)},defaultGate:E(i("default-gate-edit").value),velocityCurve:{inputMin:E(i("curve-input-min").value),inputMax:E(i("curve-input-max").value),outputMin:E(i("curve-output-min").value),outputMax:E(i("curve-output-max").value),exponent:E(i("curve-exponent").value)}}}function K(){var e;(e=u.getState().server)!=null&&e.actions.editing&&p({type:"edit_motif",properties:W()})}function Q(e){var d,c,o,l,s,b,r;let t=u.getState(),n=((c=(d=t.server)==null?void 0:d.selected)==null?void 0:c.id)!==((o=e.selected)==null?void 0:o.id),a=!!((l=t.server)!=null&&l.editing.active&&!e.editing.active);u.setState({...t,server:e,formDirty:n||a?!1:t.formDirty}),(s=e.alert)!=null&&s.id&&e.alert.id!==((r=(b=t.server)==null?void 0:b.alert)==null?void 0:r.id)&&X({title:e.alert.title,message:e.alert.message,confirmLabel:"OK",dismissOnly:!0}),I="",H!==null&&(clearTimeout(H),H=null),L("ok",\`State: \${e.items.length} motifs\${e.libraryPath?\` \\xB7 \${e.libraryPath}\`:""}\`)}function de(e){let t=Number(e.transferId),n=Number(e.index),a=Number(e.total);if(!Number.isInteger(t)||t<F||!Number.isInteger(n)||!Number.isInteger(a)||n<0||n>=a||a<1||a>1e4||typeof e.data!="string")return;if(!f||f.id!==t){if(f&&t<f.id)return;f={id:t,total:a,parts:new Array(a),received:new Set}}if(f.total!==a||(f.parts[n]=e.data,f.received.add(n),f.received.size!==a))return;let d=f.parts.join("");F=t,f=null,Q(JSON.parse(decodeURIComponent(d)))}function Y(...e){let t=e[e.length-1];try{let n=JSON.parse(decodeURIComponent(String(t)));if(P(n)){de(n),I="";return}f=null,Q(n)}catch(n){let a=k(n);if(a===I)return;I=a,L("error",\`Library data could not be displayed: \${a}\`)}}u.subscribe(z);z(u.getState());document.querySelectorAll(".panel-tab").forEach(e=>{e.addEventListener("click",()=>{let t=e.dataset.panel;(t==="properties"||t==="notes")&&u.setState({activePanel:t})})});var j=i("search");j.addEventListener("input",()=>{p({type:"filter_motifs",query:j.value})});i("clear-search").addEventListener("click",()=>{p({type:"filter_motifs",query:""})});i("choose-btn").addEventListener("click",()=>{x(()=>{var e;(e=u.getState().server)!=null&&e.editing.active&&p({type:"cancel_edit"}),S.outlet("choose_library")},"Discard the current edits and choose another library folder?")});i("refresh-btn").addEventListener("click",()=>{x(()=>p({type:"refresh_library",discardChanges:!0}),"Discard the current edits and reload the library folder?")});i("edit-btn").addEventListener("click",()=>{p({type:"begin_edit"})});i("cancel-edit-btn").addEventListener("click",()=>{x(()=>p({type:"cancel_edit"}))});i("import-clip-btn").addEventListener("click",()=>{x(()=>p({type:"import_clip",pitchMode:i("import-mode").value}),"Discard the current edits and import the selected Live clip?")});i("save-motif-btn").addEventListener("click",()=>{p({type:"save_motif",properties:W()})});i("add-note-btn").addEventListener("click",()=>{p({type:"add_note"})});i("assign-hotkey-btn").addEventListener("click",()=>{var t;let e=(t=u.getState().server)==null?void 0:t.selected;e&&p({type:"map_trigger",pitch:i("hotkey-input").value,motifId:e.id,action:i("hotkey-action").value})});i("hotkey-input").addEventListener("keydown",e=>{e.key==="Enter"&&(e.preventDefault(),i("assign-hotkey-btn").click())});for(let e of G){let t=i(e);t.addEventListener("input",()=>u.setState({formDirty:!0})),t.addEventListener("change",K),(t.tagName==="TEXTAREA"||t instanceof HTMLInputElement&&t.type==="text")&&t.addEventListener("blur",K)}i("modal-cancel").addEventListener("click",N);i("modal-backdrop").addEventListener("click",e=>{e.target===e.currentTarget&&N()});i("modal-confirm").addEventListener("click",()=>{var t;let e=u.getState().modal;N(),(t=e==null?void 0:e.onConfirm)==null||t.call(e)});document.addEventListener("keydown",e=>{e.key==="Escape"&&u.getState().modal&&N()});C?typeof S.bindInlet!="function"?L("error","Max jweb bridge is missing bindInlet"):(S.bindInlet("receiveData",Y),L("info",\`Bridge ready; waiting for library state (\${location.href})\`),S.outlet("library_ready"),H=setTimeout(()=>{u.getState().server||L("error","No library state received within 2 seconds")},2e3)):Y(encodeURIComponent(JSON.stringify({query:"",libraryPath:"/Users/example/Motifs",libraryLoaded:!0,libraryScanning:!1,scanProgress:null,editing:{active:!1,dirty:!1,created:!1,sourceId:null,targetId:null},actions:{editing:!1,canEdit:!0,canSave:!1,canImportClip:!0,canRefreshLibrary:!0},items:[{id:"chromatic-turn",name:"Chromatic Turn",showId:!1,folder:"Library",hotkeys:[]},{id:"scale-turn",name:"Scale Turn",showId:!1,folder:"Library",hotkeys:[]}],selectedIndex:0,selected:{schemaVersion:1,id:"chromatic-turn",name:"Chromatic Turn",description:"Fixed-interval phrase that ignores the selected scale.",pitchMode:"chromatic",sourceMeter:{numerator:4,denominator:4},length:3360,defaultGate:.82,velocityCurve:{inputMin:null,inputMax:null,outputMin:null,outputMax:null,exponent:null},stats:"7 notes \\u2022 0.88 bars \\u2022 4/4 source \\u2022 chromatic",isBuiltin:!0,isPersisted:!1,folder:"Built-ins",hotkeys:[],noteCount:2,noteLimit:512,canAddNote:!1,canRemoveNote:!1,notes:[{pitch:0,accidental:null,at:0,duration:480,gate:null,velocity:null,velocityOffset:null,velocityScale:null,legato:!1,tie:!1},{pitch:2,accidental:null,at:480,duration:480,gate:null,velocity:null,velocityOffset:null,velocityScale:null,legato:!1,tie:!1}]},alert:null})));})();
  ...
  function Ye(e, t, n, r = {}) {
    let i = r.motifId ?? on(e),
      o = d.resolve(i);
    if (!o) {
      l(`Unknown motif: ${i}`);
      return;
    }
    ((Je === "replace" || O === "latch") && ge(), (he = e), (Wt = !0), I());
    let s = Un++,
      a = {
        ...
        launchOffsetTicks: r.launchOffsetTicks ?? Ve(g, Ee),
        instanceId: s,
      };
    ne !== void 0 && (a.pitchMode = ne);
    for (let c of dt(ye(o, { invert: re, reverse: ie }), { ...g, tempo: g.tempo * G }, a))
      rn(c.pitch, c.velocity, c.channel, c.offsetMs);
  ...
  function qn(e, t, n) {
    ...
    let o = Ve(g, Ee);
    if (Ye(e, t, n, { motifId: i.id, launchOffsetTicks: o }) === void 0) return;
    let a,
      c = new Task(() => {
        if (F.get(e) !== a) return;
        ...
        Ye(e, a.velocity, a.channel, { motifId: a.motifId, launchOffsetTicks: 0 }) === void 0 ||
          F.get(e) !== a ||
          a.task.schedule(ze(f, oe, g, G));
      });
    ((a = { motifId: i.id, velocity: t, channel: n, task: c }), F.set(e, a));
    let u = J(o, g.tempo * G) + ze(i, oe, g, G);
    (c.schedule(Math.max(xe, u)), m("repeat-started", i.id, e));
  }
  function Kt(e) {
    ue.has(e) && (ge(), m("release", e));
  }
  function Qn(e, t, n = 1) {
    let r = Math.round(v(e, 0, 127)),
      ...
      s = L.get(r),
      a = !!s || F.has(r) || (r >= fe && r <= me);
    if (((le === "all" || (le === "non-triggers" && !a)) && rn(r, i, o, 0), !!a)) {
      if (s?.action === "select") {
        i > 0 && (Xe(s.motifId), d.currentId === s.motifId && m("selected", s.motifId, r));
        return;
      }
      if (O === "hold-repeat" || F.has(r)) {
        i > 0 ? O === "hold-repeat" && qn(r, i, o) : te ? pe.add(r) : B(r);
        return;
      }
      if (i > 0) {
        if (O === "toggle" && ue.has(r)) {
          Kt(r);
          return;
        }
        Ye(r, i, o) !== void 0 && O !== "one-shot" && ue.add(r);
        return;
      }
      O === "hold" ? (te ? Ae.add(r) : Kt(r)) : O === "release-tail" && ue.delete(r);
    }
  }
  function sn(e, t, n = 1) {
    let r = Math.round(v(e, 0, 127)),
    ...
    if (((te = i >= 64), o && !te)) {
      for (let s of [...pe]) B(s);
      (pe.clear(), Ae.size > 0 && ge(), Ae.clear());
    }
    m("sustain", te ? "on" : "off");
  }
  function Jn(e, t = 1) {
      ...
      if (b.isEditing()) {
        if (b.isDirty()) {
          (l("Save or cancel the current edits before selecting another motif"),
            S("motif-selected", d.labels().get(d.currentId) ?? d.current?.name ?? d.currentId),
            M());
          return;
        }
        if ((b.cancel(d), (t = d.resolve(e)), !t)) {
          (l(`Unknown motif after cancelling edit: ${e}`), A());
          return;
        }
      }
      (d.select(t.id),
        S("motif-selected", d.labels().get(t.id) ?? t.name),
        I(),
        q(),
        m("Motif", t.name));
    }
  ...
  function We() {
    S("ui", "transforms", re ? 1 : 0, ie ? 1 : 0);
  }
  function Wn(e) {
    ((re = Ue(e)), We(), I(), m("invert", re ? "on" : "off"));
  }
  function Xn(e) {
    ((ie = Ue(e)), We(), I(), m("reverse", ie ? "on" : "off"));
  }
  function Zn(e) {
    if (!Y(e, It)) {
  ...
  function tr(e) {
    ...
    let t = e;
    (O === "hold-repeat" && t !== "hold-repeat" && Ke(), (O = t), m("trigger-mode", O));
  }
  function nr(e) {
    if (!Y(e, wt)) {
  ...
  function rr(e) {
    ...
    ((le = e), nn(), m("pass-through", le));
  }
  function ir(e) {
    ((fe = Math.min(me, Math.round(v(e, 0, 127)))), m("trigger-zone", fe, me));
  }
  function or(e) {
    ((me = Math.max(fe, Math.round(v(e, 0, 127)))), m("trigger-zone", fe, me));
  }
  function an(e, t, n = "trigger") {
    let r = L.assign(e, t, n);
    if (!r.ok) {
      Zt("Invalid MIDI hot key", r.error);
      return;
    }
    let { pitch: i, motifId: o, action: s } = r.assignment;
    (B(i, !1), M(), q(), m("mapped", i, o, s));
  }
  function cn(e) {
    let t = L.remove(e);
    if (t === void 0) {
    ...
    (B(t, !1), M(), q(), m("unmapped", t));
  }
  function un() {
    for (let e of L.clear()) B(e, !1);
    (M(), q(), m("map-cleared"));
  }
  function dn() {
    for (let e of L.prune()) B(e, !1);
  }
  function sr(...e) {
    let t = Et(e);
    if (t) {
      ...
      if (t === p.path && (p.loaded || p.scanning)) {
        M();
        return;
      }
      (b.abandon(), p.selectPath(t));
    }
  }
  function ln(e) {
    if (b.isDirty() && !je(e)) {
    ...
    (b.abandon(), p.load("library-refreshed"));
  }
  function ar(e) {
    let t = Ot(e);
    if (t === void 0) {
    ...
    ((G = t), I(), m("tempo-multiplier", G));
  }
  function fn(...e) {
    ((de = $t(e)), M(), m("filter", de || "(all)"));
  }
  function mn(e = "chromatic") {
    if (p.scanning) {
    ...
    if (r.length > Z) {
      Zt(
        ...
        `The selected MIDI clip contains ${r.length} notes. Motif can import up to ${Z} editable notes. Shorten the clip or split it into smaller phrases, then import it again.`,
      );
      return;
    }
    ...
    try {
      s = at(r, {
        ...
        name: o,
        pitchMode: t,
        scaleRootNote: g.rootNote,
        scaleIntervals: g.scaleIntervals,
        sourceMeter: { ...g.timeSignature },
    ...
    let c = p.uniqueId(o, `clip-${Date.now()}`);
    try {
      let u = { ...s, id: c },
        f = d.add(u);
      if (f.length > 0) {
        (d.select(a) || d.ensureCurrent(H), A(), l(f.join("; ")));
        return;
      }
      if (!b.begin(d, c, { dirty: !0, created: !0, sourceId: a })) {
        (d.remove(c),
          d.select(a) || d.ensureCurrent(H),
          l("Could not start editing the imported motif"),
          A());
        return;
      }
      (d.select(c), A(), m("imported-clip", c, r.length));
    } catch (u) {
      (d.remove(c),
        d.select(a) || d.ensureCurrent(H),
        b.abandon(),
  ...
  function pn(e) {
    let t = Pe();
    if (!t) return !1;
    let n = ht(t, e, { triggerPitch: he, host: g });
  ...
  function hn(e) {
    ...
    try {
      let n = p.save(t.id);
      (b.finishSave(), A(), q(), m("saved", t.id, n));
    } catch (n) {
  ...
  function gn() {
    ...
    let e = d.current,
      t = e && d.isBuiltin(e.id) ? p.uniqueId(e.name, `${e.id}-copy`) : void 0,
      n = b.begin(d, d.currentId, t ? { targetId: t } : {});
    if (!n) {
      l("Could not start editing the selected motif");
      return;
    }
    (d.select(n.id), A(), m("editing", n.id, n.name));
  }
  function bn() {
    let e = b.cancel(d);
    if (!e) {
    ...
    (d.select(e) || d.ensureCurrent(H), dn(), A(), q(), m("editing-cancelled", d.currentId));
  }
  function yn(e) {
    pn(e) && (I(), m("motif-edited", d.currentId));
  }
  function Xe(e, t) {
    ...
    r &&
      (d.select(r.id),
      S("motif-selected", d.labels().get(r.id) ?? r.name),
      I(),
      q(),
      m("Motif", r.name));
  }
  function cr(e, t, n) {
    ...
    return o.length > 0
      ? (l(o.join("; ")), !1)
      : (b.markDirty(), I(), m("note-edited", e, t, i.statusValue ?? "unset"), !0);
  }
  function ur(e, t, n) {
    cr(Math.round(e), String(t), n);
  }
  function dr() {
    let e = Pe();
    if (!e) return;
  ...
  function fr(...e) {
    ...
    switch (i) {
      case "select_browser":
        Xe(T(r.id), r.discardChanges);
        break;
      case "filter_motifs":
        fn(r.query);
        break;
      case "import_clip":
        mn(r.pitchMode !== void 0 ? T(r.pitchMode) : void 0);
        break;
      case "save_motif":
        hn(r.properties);
        break;
      case "refresh_library":
        ...
        break;
      case "map_trigger":
        an(typeof r.pitch == "number" ? r.pitch : T(r.pitch), T(r.motifId), T(r.action, "trigger"));
        break;
      case "unmap_trigger":
        cn(typeof r.pitch == "number" ? r.pitch : T(r.pitch));
        break;
      ...
      case "remove_note":
        ...
        break;
      case "edit_note_at":
        ur(Number(r.index), T(r.field), r.value);
        break;
      default:
  ...
  function pr() {
    S("context", g.tempo, g.rootNote, g.scaleName, ...g.scaleIntervals);
  }
  var hr = {
    initialize: zn,
    preview_ready: en,
    ...
    retrigger: er,
    trigger_mode: tr,
    launch_quantization: nr,
    pass_through: rr,
    trigger_low: ir,
    trigger_high: or,
    map_trigger: an,
    unmap_trigger: cn,
    clear_trigger_map: un,
    library_path: sr,
    refresh_library: ln,
    tempo_multiplier: ar,
    filter_motifs: fn,
